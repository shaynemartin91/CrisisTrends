...
window.faq = {
  'About Crisis Trends Data': {
    ...
    'questions': {
        'What is Crisis Trends?': `
          Crisis Text Line was originally built with two purposes:
            <ol>
              <li>
                to provide a free, 24/7 crisis service via text at scale and
              </li>
              <li>
                to use the data generated to improve our service and the crisis
                space as a whole.
              </li>
          Crisis Trends was launched to share the volume, velocity, and variety
          of our data with the public.
          `,
        'Why do we share this data?': `
          By sharing this data, we hope to:
            <ol>
              <li>
                increase public awareness about how crisis and help-seeking
                occurs in real-time
              </li>
              <li>
                in doing so, decrease stigma around help-seeking
              </li>
              <li>
                provide community members, policy makers, journalists, and
                organizations with insights to support their efforts to improve
      ...
      'What can / can\'t I do with Crisis Trends data?': {
        ...
        'You CAN:': `
            <ul>
              <li>Explore how issues vary across texters from different states.</li>
              <li>Explore how crisis conversations occur in real-time, across the week and different hours of the day.</li>
              <li>Explore trends for a specific issue.</li>
            </ul>`,
        'You CAN\'T:': `
            <ul>
              <li>Infer reason for the trend (but we encourage you to research your hypotheses further!)</li>
              <li>Select a slice of data so narrow that it might compromise texter privacy or provide a skewed view.</li>
              <li>Assume our texter population is representative of the U.S. as a whole. Roughly 75% of our texter population is below 25 years old. That being said, we've exchanged tens of millions of text messages, in every area code in the U.S., so the data on texters in crisis is rich.</li>
            </ul>`,
      },
